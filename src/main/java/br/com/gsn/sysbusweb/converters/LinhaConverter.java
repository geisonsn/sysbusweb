...
@FacesConverter(value= "ConversorLinha")
public class LinhaConverter implements Converter {

	private LinhaDAO linhaDAO = Beans.getReference(LinhaDAO.class);
		...
		Object ret = null;
			if (component instanceof PickList) {
				...
				for (Object o : dl.getSource()) {
					String id = String.valueOf(((Linha) o).getId());
					if (value.equals(id)) {
						ret = o;
						break;
					}
